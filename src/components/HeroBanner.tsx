...
/** Flat illustration: citizen's complaint travelling across a bridge (setu)
...
function CivicIllustration() {
  return (
    ...
    >
      ...
      {/* government building */}
      <g>
        <rect x="168" y="86" width="92" height="64" rx="3" fill="#E8ECF7" stroke="var(--navy)" strokeWidth="2" />
        <polygon points="164,86 264,86 214,58" fill="var(--navy)" />
        <rect x="206" y="112" width="16" height="38" rx="2" fill="var(--navy)" />
        <rect x="180" y="100" width="14" height="18" rx="2" fill="#fff" stroke="var(--navy)" strokeWidth="1.5" />
        <rect x="234" y="100" width="14" height="18" rx="2" fill="#fff" stroke="var(--navy)" strokeWidth="1.5" />
        {/* flag */}
        <line x1="214" y1="58" x2="214" y2="34" stroke="var(--ink)" strokeWidth="2" />
        <rect x="214" y="34" width="20" height="5" fill="var(--saffron)" />
        <rect x="214" y="39" width="20" height="5" fill="#fff" stroke="var(--border-hover)" strokeWidth="0.5" />
      ...
      <g transform="rotate(-8 85 96)">
        <rect x="70" y="86" width="30" height="21" rx="3" fill="#fff" stroke="var(--saffron)" strokeWidth="2" />
